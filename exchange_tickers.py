...
# Define paths to CSV files - FIXED PATHS FOR STREAMLIT CLOUD
NYSE_CSV_PATH = '/mount/src/v10/NYSEtickers.csv'
NASDAQ_CSV_PATH = '/mount/src/v10/NASDAQtickers.csv'
AMEX_CSV_PATH = '/mount/src/v10/AMEXtickers.csv'
